...
contract BaseSepoliaScript is Script {
    ...
    IPoolManager constant manager = IPoolManager(address(0x05E73354cFDd6745C338b50BcFDfA3Aa6fA03408));
    PoolModifyLiquidityTest lpRouter = PoolModifyLiquidityTest(address(0x37429cD17Cb1454C34E7F50b09725202Fd533039));
